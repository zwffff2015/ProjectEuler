 ...
 */
public class P8 {
    public static long getGreatestProduct(int number) {
        int[][] numbers = new int[][]{
        ...
        long temp = 1;
        long result = 1;
        for (int i = 0; i <= (total - number + 1); ) {
            temp = 1;
            k = i + number - 1;
            for (int j = i; j <= k; j++) {
                int oneIndex = j / numbers[0].length;
                int twoIndex = j % numbers[0].length;
                temp *= numbers[oneIndex][twoIndex];

                if (numbers[oneIndex][twoIndex] == 0) {
                    i = j + 1;
                    break;
                }
            }
